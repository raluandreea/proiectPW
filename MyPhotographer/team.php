			...
			<div class="container">
				<div class="row animate-box">
					<div class="col-md-8 col-md-offset-2 text-center heading-section">
						<h2>Meet Us.</h2>
						<h3>Gathered by Passion</h3>
					</div>
				</div>
				<div class="row">
					<div class="col-md-4 col-sm-6">
						<div class="team-section-grid" style="background-image: url(images/mike.jpg);">
							<div class="overlay-section">
								<div class="desc">
									<h3>Mike Paul</h3>
									<span>{Portaits Photographer}</span>
					...
					<div class="col-md-4 col-sm-6"> 
						<div class="team-section-grid" style="background-image: url(images/ana.jpg);"> 
							<div class="overlay-section"> 
								<div class="desc"> 
									<h3>Ana Meher.</h3> 
					 ...
					 <div class="col-md-4 col-sm-6"> 
						 <div class="team-section-grid" style="background-image: url(images/harry.jpg);"> 
							 <div class="overlay-section"> 
								 <div class="desc"> 
									 <h3>Harry Gordan.</h3> 
					...
					<!-- </div> -->
					<!-- <div class="col-md-4 col-sm-6"> -->
						<!-- <div class="team-section-grid" style="background-image: url(images/author-5.jpg);"> -->
							<!-- <div class="overlay-section"> -->
								<!-- <div class="desc"> -->
									<!-- <h3>John Doe</h3> -->
									<!-- <span>Chief Executive Officer</span> -->
